  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
         Text(
          name,
          style: const TextStyle(color: Color(0xFF230E4E), fontSize: 24),
        ),
        const Spacer(),
        // const SizedBox(
        //   width: 120,
        // ),
          Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text("VERES  $numberOfAyahs ",style: TextStyle(color: const Color(0xff8789A3),fontSize: 12.sp),),
                  SizedBox(width: 6.w,),
                  Text(revelationType,style: TextStyle(color: const Color(0xff240F4F),fontSize: 12.sp),),
                ],
              )
            ],
          ),
